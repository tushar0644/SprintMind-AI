  ...
  <div className="hidden lg:flex w-1/2 bg-stitch-primary text-white flex-col justify-between p-12 relative overflow-hidden select-none">
    ...
    <div className="relative z-10 max-w-[448px] my-auto space-y-6">
      <h2 className="text-3xl font-extrabold tracking-tight leading-tight text-white font-sans">
        Unlock Agile Intelligence
      </h2>
      <p className="text-xs text-white/70 leading-relaxed font-sans font-medium">
        Create an account to access automated sprint correlation tools, collaborative dashboard statistics, and smart team workspace management.
      </p>
        ...
        <Card className="max-w-md w-full border border-stitch-outline-variant/60 bg-white p-8 shadow-xl rounded-2xl select-none">
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-stitch-on-surface-variant mt-2 font-medium">
              Create your developer workspace account
            </p>
          </div>
          ...
          <form onSubmit={handleSignUp} noValidate className="space-y-4 select-text">
            <div className="flex flex-col space-y-1.5 w-full">
              <label className="text-xs font-semibold text-stitch-on-surface-variant select-none">Full Name</label>
              <input
                type="text"
                value={displayName}
            ...
            <div className="flex flex-col space-y-1.5 w-full">
              <label className="text-xs font-semibold text-stitch-on-surface-variant select-none">Password</label>
            ...
            <div className="flex flex-col space-y-1.5 w-full">
              <label className="text-xs font-semibold text-stitch-on-surface-variant select-none">Confirm Password</label>
              <div className="relative">
                <input
            ...
            <div className="flex flex-col space-y-1.5 w-full">
              <label className="text-xs font-semibold text-stitch-on-surface-variant select-none">Workspace Role</label>
              <select
                value={role}
